...
export const TEAM_PARODY_ROSTERS: Record<string, ParodyPlayerTemplate[]> = {
  ...
  'Brooklyn|Union': [
    { firstName: 'Justin', lastName: 'Minott', position: 'SF' },
    { firstName: 'Zane', lastName: 'Williamss', position: 'SF' },
    { firstName: 'Derek', lastName: 'Wolff', position: 'SF' },
    { firstName: 'Derek', lastName: 'Powell', position: 'SG' },
    { firstName: 'Evan', lastName: 'Dëminn', position: 'SG' },
    { firstName: 'Elias', lastName: 'Liddell', position: 'SF' },
  ...
  'Toronto|Sentinel': [
    ...
    { firstName: 'Roland', lastName: 'Barrett', position: 'SF' },
  ],
  'Chicago|Gale': [
    { firstName: 'Chris', lastName: 'Sextonn', position: 'SG' },
    { firstName: 'Jonas', lastName: 'Giddeyy', position: 'SG' },
    { firstName: 'Miles', lastName: 'McClungg', position: 'SG' },
    { firstName: 'Roland', lastName: 'Dillinghamm', position: 'SG' },
    { firstName: 'Yusuf', lastName: 'Kawamuraa', position: 'SG' },
    { firstName: 'Liam', lastName: 'Millerr', position: 'SF' },
  ...
  'Cleveland|Rust': [
    ...
    { firstName: 'Spencer', lastName: 'Merrill', position: 'SG' },
  ...
  'Indiana|Velocity': [
    ...
    { firstName: 'Travis', lastName: 'McConnell', position: 'SG' },
  ],
  'Milwaukee|Hops': [
    { firstName: 'Jonas', lastName: 'Simss', position: 'C' },
    { firstName: 'Marcus', lastName: 'Turnerr', position: 'C' },
    { firstName: 'Gideon', lastName: 'Trentt Jr.', position: 'SG' },
    { firstName: 'Keith', lastName: 'Porterr Jr.', position: 'SG' },
    { firstName: 'Brooks', lastName: 'Portiss', position: 'SF' },
    { firstName: 'Gavin', lastName: 'Harriss', position: 'SG' },
    { firstName: 'Trevor', lastName: 'Princee', position: 'SF' },
  ],
  'Atlanta|Peachtree': [
  ...
  'Washington|Monument': [
    ...
    { firstName: 'Dante', lastName: 'Russell', position: 'SG' },
  ...
  'Portland|Rose': [
    ...
    { firstName: 'Sean', lastName: 'Hendersonn', position: 'SG' },
    { firstName: 'Dante', lastName: 'Lillardd', position: 'SG' },
    { firstName: 'Brooks', lastName: 'Wesleyy', position: 'SG' },
    { firstName: 'Colin', lastName: 'Lovee', position: 'SG' },
    { firstName: 'Colin', lastName: 'Youngbloodd', position: 'SG' },
    { firstName: 'Malik', lastName: 'Thybullee', position: 'SG' },
  ],
  'Utah|Mesa': [
    ...
    { firstName: 'Ethan', lastName: 'Harkless', position: 'SG' },
  ],
  ...
  'LA|Current': [
    { firstName: 'Noah', lastName: 'Omierr', position: 'SF' },
    { firstName: 'Simon', lastName: 'Pedullaa', position: 'SG' },
    { firstName: 'Bryce', lastName: 'Beall', position: 'SG' },
    { firstName: 'Keith', lastName: 'Leonardd', position: 'SF' },
    { firstName: 'Keith', lastName: 'Sanderss', position: 'SG' },
    { firstName: 'Damian', lastName: 'Joness Jr.', position: 'SF' },
    { firstName: 'Ben', lastName: 'Bogdanovicc', position: 'SG' },
  ],
  'LA|Cosmos': [
    { firstName: 'Landon', lastName: 'Donkcicc', position: 'SF' },
    { firstName: 'Leandro', lastName: 'Jhames', position: 'SF' },
    ...
    { firstName: 'Jonas', lastName: 'Vanderbildt', position: 'SF' },
  ],
  'Phoenix|Sol': [
    { firstName: 'Ryan', lastName: 'O\'Nealee', position: 'SF' },
    { firstName: 'Roland', lastName: 'Dunn', position: 'SF' },
  ...
  'Sacramento|Republic': [
    ...
    { firstName: 'Darius', lastName: 'McDermott', position: 'SF' },
  ...
  'Dallas|Lasso': [
    ...
    { firstName: 'Nate', lastName: 'Marshall', position: 'SF' },
  ],
  'Houston|Comets': [
