...
function scenarioFranchise(
  ...
  return {
    ...
    draftPicks: extras.draftPicks ?? [
      { year: LEAGUE_CALENDAR_YEAR + 1, round: 1, originalTeam: `${city} ${name}` },
      { year: LEAGUE_CALENDAR_YEAR + 2, round: 1, originalTeam: `${city} ${name}`, protections: 'Top-8 protected' },
      { year: LEAGUE_CALENDAR_YEAR + 3, round: 1, originalTeam: `${city} ${name}` },
      { year: LEAGUE_CALENDAR_YEAR, round: 2, originalTeam: `${city} ${name}` },
      { year: LEAGUE_CALENDAR_YEAR + 1, round: 2, originalTeam: `${city} ${name}` },
      { year: LEAGUE_CALENDAR_YEAR + 2, round: 2, originalTeam: `${city} ${name}` },
      { year: LEAGUE_CALENDAR_YEAR + 3, round: 2, originalTeam: `${city} ${name}` },
    ],
